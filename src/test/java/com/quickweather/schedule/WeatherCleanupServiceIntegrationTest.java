...
public class WeatherCleanupServiceIntegrationTest extends IntegrationTestConfig {
    ...
    void testArchiveOldWeatherData_WithDatabase() {
        ...
        OperationType.WeatherApiResponse oldData = new OperationType.WeatherApiResponse();
        ...
        OperationType.WeatherApiResponse recentData = new OperationType.WeatherApiResponse();
        ...
        List<OperationType.WeatherApiResponse> currentData = weatherApiResponseRepository.findAll();
